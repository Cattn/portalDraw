...
<div class="w-20 fixed right-0 top-0 rounded-l-3xl z-10 bg-primary-container h-screen">
    <div class="flex flex-col items-center justify-between h-full">
        ...
        <div class="flex flex-col mb-5 items-center gap-4">
            ...
            <Button click={() => goto('/settings')} square iconType="full" variant="filled">
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
