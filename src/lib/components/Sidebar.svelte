...
{#if isVisible}
	<div
		class="bg-primary-container fixed top-0 right-0 z-10 h-screen w-20 rounded-l-3xl"
	...
	>
		<div class="flex h-full flex-col items-center justify-between">
			<div
				...
				{...animateTransitions
					? { in: scale, params: { duration: 400, delay: 300, easing: quintOut } }
					: {}}
			>
			...
			<div
				...
				{...animateTransitions
					? { in: scale, params: { duration: 400, delay: 400, easing: quintOut } }
					: {}}
			>
				<Button
					square
